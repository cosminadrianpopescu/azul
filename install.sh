...
if [ ! -d $VESPER_PREFIX/share/vesper/provider-configs ]
then
...
cp $VESPER_DIR/nvim/lua/error_handling.lua $VESPER_PREFIX/share/vesper/nvim/lua
cp $VESPER_DIR/nvim/lua/passthrough.lua $VESPER_PREFIX/share/vesper/nvim/lua
